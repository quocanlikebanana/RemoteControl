...
//		ProcessThread processList = new ProcessThread(host, 8080, contentPane);
		...
		btnShutDown.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Image image = imageIcon.getImage().getScaledInstance(120, 150, java.awt.Image.SCALE_SMOOTH);
				imageIcon = new ImageIcon(image);
				
				int choice = JOptionPane.showConfirmDialog(btnShutDown, "Server will be shut down immediately?",
						"Shut down", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, imageIcon);
